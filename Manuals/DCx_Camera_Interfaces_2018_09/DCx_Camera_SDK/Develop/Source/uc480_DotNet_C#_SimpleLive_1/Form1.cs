...
namespace SimpleLive
{
    public partial class uc480_DotNet_Simple_Live : Form
    {
        ...
        private Bitmap displayBMP = null, tmpBMP;
        ...
        public uc480_DotNet_Simple_Live()
        {
            ...
            displayBMP = new Bitmap(1, 1);

            InitCamera();

            bool flash = Camera.IO.Flash.IsOpened;
        }
        ...
        private void onFrameEvent(object sender, EventArgs e)
        {
            ...
            g.DrawLine(Pens.Cyan, tmpBMP.Width / 2, 0, tmpBMP.Width / 2, tmpBMP.Height);
            g.DrawLine(Pens.Cyan, 0, tmpBMP.Height/2, tmpBMP.Width, tmpBMP.Height/2);
            lock (bmpLock)
            {
                displayBMP.Dispose();
                displayBMP = new Bitmap(tmpBMP);
            }
        ...
        private void DisplayWindow_Paint(object sender, PaintEventArgs e)
        {
            lock (bmpLock)
            {
                ...
                e.Graphics.DrawImage(displayBMP, DisplayWindow.ClientRectangle);
            }
        }
    }
}
