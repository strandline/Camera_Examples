...
namespace DotnetCockpit
{
    public partial class PictureControl : IControl
    {
        ...
        public PictureControl(uc480.Camera camera)
            : base(camera)
        {
            InitializeComponent();
        ...
        public override void OnControlFocusActive()
        {
            ...
            uc480.Defines.ActivateMode activeMode;
            m_Camera.AutoFeatures.Software.WhiteBalance.GetEnable(out activeMode);

            if (activeMode != uc480.Defines.ActivateMode.Disable)
            {
                radioButtonWhitebalanceOnce.Checked = (activeMode & uc480.Defines.ActivateMode.Enable) 
                    == uc480.Defines.ActivateMode.Enable;
                radioButtonWhitebalanceAuto.Checked = (activeMode & uc480.Defines.ActivateMode.Once) 
                    == uc480.Defines.ActivateMode.Once;
            }
            else
            {
        ...
        {
            m_Camera.AutoFeatures.Software.WhiteBalance.SetEnable(uc480.Defines.ActivateMode.Once);
