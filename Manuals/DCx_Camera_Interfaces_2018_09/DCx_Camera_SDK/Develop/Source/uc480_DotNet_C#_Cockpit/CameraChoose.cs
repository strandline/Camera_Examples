...
namespace DotnetCockpit
{
    public partial class CameraChoose : Form
    {
        ...
        public CameraChoose()
        {
            ...
            uc480.Info.Camera.EnableMessage(true);
            
            uc480.Info.Camera.EventNewDevice += onCameraEvent;
            uc480.Info.Camera.EventDeviceRemoved += onCameraEvent;
        ...
        private void UpdateCameraList()
        {
            ...
            foreach (uc480.Types.CameraInformation info in cameraList)
            {
        ...
        private void CameraChoose_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            uc480.Info.Camera.EnableMessage(false);
